        ...
        <table class="table" id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ ucwords(strtolower($credit->description)) }}</td>
                    <td><span class='badge bg-primary'>{{ $credit->method == 1 ? "CASH" : "TRF" }}</span></td>
                    <th>
                        <span class="badge" style="background: {{ $credit->category->color }}">
